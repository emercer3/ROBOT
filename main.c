 ...
 * Author: emercer3
 *
 * Created on December 7, 2024, 3:08 PM
 */
...
void linefollow(void) {   
    while (1) {
        _LATB7 = 1;
       if (ADC1BUF12 > 800) { // read IR sensor
            _LATB7 = 0;
            steps = 0;
            __delay_ms(13000);
            ballcollect();
       ...
       if (ADC1BUF14 < 3500 && state == 4) { // far left  && state == 4
            _LATB7 = 0; 
            enterdoc();
            break;
       } 
