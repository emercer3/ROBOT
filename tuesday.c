 ...
 * Author: emercer3
 *
 * Created on November 26, 2024, 3:13 PM
 */
...
void canyon(void){
    while (1) {
        ...
        if ((ADC1BUF9 < 1551) || (ADC1BUF10 < 1551) || (ADC1BUF11 < 1551)) { // senses line
...
int main()
{
    ...
    while(1) {
        ...
        // START STATING STATES
        if ((ADC1BUF9 > 1551) && (ADC1BUF10 > 1551) && (ADC1BUF11 > 1551)) {
            canyon();
        } else {
            _LATB7 = 0;
            linefollow();
...
//        }
        ...
        // CHeck linefollow sensors
//        if (ADC1BUF10 < 1551) { 
//            _LATB7 = 1; //there is a line
//        } else {
//            _LATB7 = 0;
//        }
...
//        // AD RANGE SENSOR AND LIGHT LED (CANYON)
//        OC1RS = 80; // old 79 
//        OC1R = OC1RS * .5;
//        OC2RS = 80; 
//        OC2R = OC2RS * .5;
